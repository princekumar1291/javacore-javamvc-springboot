...
<html lang="en">
  <head>
    ...
    <title>My Spring Search</title>
  </head>
  <body>
  	
  	<img alt="my image" src="<c:url value="/resources/image/dog.jpg"/>">
    <div class="container">
    	...
    	<div class="card mx-auto mt-5 bg-primary" style="width: 50%">
    		<div class="card-body py-5">
    			...
    			<h3 class="text-center text-white " style="text-transform:uppercase">My Spring Search</h3>
